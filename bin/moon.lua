-- OpenOS requirments
-- local function addPackagePath(pth)local pp=package.path if pp:find(pth,1,true)==nil then
--     package.path = pp..";"..pth end end

-- addPackagePath"LuLPeg/?.lua"

-- debug.getupvalue = function(fn, lvl)
--   if lvl == 1 then return "_ENV", _ENV end
--   error("debug.getupvalue CALL")
-- end


-- debug.upvaluejoin = function(f1, n1, f2, n2)
--   print("debug.upvaluejoin CALL")
-- end

local _print = print
print = function(...) _print(...); os.sleep(0) end
